  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* AI Report Section */}
        <div className="bg-gradient-to-br from-blue-50 to-purple-100 rounded-2xl shadow-lg p-4 sm:p-8 mb-8 border border-blue-200 dark:border-blue-700 dark:bg-gradient-to-br dark:from-gray-900 dark:to-blue-950">
